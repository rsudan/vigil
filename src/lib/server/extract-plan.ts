...
- Tie-breakers: a rule from a body the owner cannot change is 1 and the domestic law transposing it is 6; a dated event that crosses a line is 8, a slow trend is 1; evidence about whether THIS plan's causal chain works is 3 even from abroad, what another jurisdiction did is 9; a technology development is 2, and 10 only when it comes with a dated application or closing window.
