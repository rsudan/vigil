...
export default defineConfig(({ command, isPreview }) => ({
  ...
  // Pre-bundle the client dependencies discovered lazily on first use. Without
  // this, Vite finds them as pages load and reloads the browser mid-session,
  // which closes dialogs and drops an upload in progress.
  optimizeDeps: {
    include: [
      "react",
      "react-dom",
      ...
      "@radix-ui/react-tabs",
      // Transitive client imports Vite otherwise discovers one page at a time.
      // Version-specific: an entry that stops resolving only logs a warning.
